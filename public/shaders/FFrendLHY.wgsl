...
@group(2) @binding(2) var transformHighTexture: texture_2d<f32>;
@group(2) @binding(3) var transformLowTexture: texture_2d<f32>;
@group(2) @binding(4) var projectionTex: texture_2d<f32>;
