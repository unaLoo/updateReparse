...
const init = async (sceneTexture) => {
    ...
    // parser = new DescriptionParser("/json/flow_field_description_new.json")
    ...
    // const projectionTex = Scratch.imageLoader.load('transformTexture',parser.transform2DResource)
...
function showFlowField(visibility) {
